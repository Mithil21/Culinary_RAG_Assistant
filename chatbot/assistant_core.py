...
print("Loading Qwen2.5-0.5B-Instruct Model (The Brain)...")
rewriter_id = "Qwen/Qwen2.5-0.5B-Instruct"
rewriter_tokenizer = AutoTokenizer.from_pretrained(rewriter_id)
rewriter_model = AutoModelForCausalLM.from_pretrained(rewriter_id, device_map="auto")
...
# 7. DJANGO INTERFACE
# ==========================================
def get_assistant_response(user_input: str, chat_history: list) -> dict: # <-- Added parameter
    try:
